...
public class MyServlet extends HttpServlet {
    ...
    protected void service(HttpServletRequest request, HttpServletResponse response) {
        ...
        request.setAttribute("username",username); //No use if we do sendRedirect, with RequestDispatcher this will be retrieved.
        request.setAttribute("rolename",rolename);
        
        boolean isValidUser = validateUser(username, password, rolename);
    ...
    public boolean validateUser(String user, String pwd, String role){
